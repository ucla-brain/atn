...
//         var inside_text_eles = Array.from(g_ele.querySelectorAll('text'));
//         var text_ele = Array.from(g_ele.querySelectorAll('texts'));
//         var line_eles = Array.from(g_ele.querySelectorAll('line'));

//         // Previous Versions of above query selectors
//         // var inside_text_eles = Array.from(g_ele.querySelectorAll(':scope > g > text'));
